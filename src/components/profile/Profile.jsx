...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`backendprojecr-production.up.railway.app/api/v2/post/getUserPosts/${user1Id}`, {
        headers: {
          Authorization: `Bearer ${cookies.token}`,
        },
      })
  ...
  const Delete_Post = async () => {
    try {
      ...
      await axios.delete(
        `backendprojecr-production.up.railway.app/api/v2/post/${Confirm_deletionnID}`,
        {
          headers: { Authorization: `Bearer ${cookies.token}` },
        }
      );
                ...
                <div className="profile">
                  <div className="back_img">
                    <img
                      src={
                        MyData.Cover_image
                          ? `backendprojecr-production.up.railway.app/user/${MyData.Cover_image}`
                          : "./image/back1.jpg"
                      }
                      alt=""
                    />
