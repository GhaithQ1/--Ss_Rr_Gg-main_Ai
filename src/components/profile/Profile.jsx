              ...
              <>
                <div className="profile">
                  <div className="back_img">
                    <img
                      src={
                        MyData.Cover_image
                          ? `https://backendprojecr-production.up.railway.app/user/${MyData.Cover_image}`
                          : "./image/back1.jpg"
                      }
                      alt=""
                    />
                ...
                {MyData.description && MyData.role === "employee" ? (
                  <div className="description_profile">
                    <h3>Description:</h3>
                    <p style={{ whiteSpace: "pre-line" }}>{MyData.description}</p>
                ...
                <div className="bosts">
                  {posts.length === 0 ?
                    MyData.role === "employee" || MyData.role === "admin" ? (<h3>
                            ...
                            >
                              ...
                              <div className="name_shoole">
                                <img
                                  src={
                                    post.user
                                      ? `https://backendprojecr-production.up.railway.app/user/${post.user.profilImage}`
                                      : "/image/pngegg.png"
                                  }
                                  alt=""
                                />
