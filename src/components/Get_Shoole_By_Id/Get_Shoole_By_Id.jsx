...
const Get_Shoole_By_Id = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`backendprojecr-production.up.railway.app/api/v2/user/${idParams}`, {
        headers: {
  ...
  useEffect(() => {
    if (!idParams) return; // لا تعمل شي إذا ما وصل الاي دي
    axios
      .get(`backendprojecr-production.up.railway.app/api/v2/post/getUserPosts/${idParams}`, {
        headers: {
          Authorization: `Bearer ${cookies.token}`,
        },
      })
  ...
  const sendFriendRequest = (id) => {
    ...
    axios
      .post(
        `backendprojecr-production.up.railway.app/api/v2/auth/Send_friend_request/${id}`,
        {},
        {
          headers: { Authorization: `Bearer ${cookies.token}` }, // إضافة التوكن في الهيدر
        }
  ...
  const acceptRequest = async (id) => {
    try {
      setLoad(true);
      await axios.post(
        `backendprojecr-production.up.railway.app/api/v2/auth/Accept_friend_request/${id}`,
        {},
        {
          headers: { Authorization: `Bearer ${cookies.token}` }, // إضافة التوكن في الهيدر
        }
  ...
  const rejectRequest = async (id) => {
    try {
      setLoad(true);
      await axios.post(
        `backendprojecr-production.up.railway.app/api/v2/auth/Reject_friend_request/${id}`,
        {},
        {
          headers: { Authorization: `Bearer ${cookies.token}` }, // إضافة التوكن في الهيدر
        }
                    ...
                    <img
                      src={
                        GetDataById.Cover_image
                          ? `backendprojecr-production.up.railway.app/user/${GetDataById.Cover_image}`
                          : "./image/back1.jpg"
                      }
                      alt=""
                    />
                    ...
                    src={
                      GetDataById.googleId
                        ...
                        : GetDataById.profilImage
                          ? `backendprojecr-production.up.railway.app/user/${GetDataById.profilImage}`
                          : "/image/pngegg.png"
                    }
